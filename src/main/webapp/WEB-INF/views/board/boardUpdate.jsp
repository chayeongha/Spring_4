		...
		<form action="./${board}Update" method="post" id="frm">
			...
			<div class="form-group">
				<label for="name">WRITER</label> <input type="text"
					class="form-control" id="writer" value="${dto.writer}"
   		...
   		<div>
	   		...
	   		<div id="f${file.fnum}">
	   			<p>${file.oname} <input type="button" id="${file.fnum}" value="delete" class="btn btn-danger del_file"> </p>
	   		</div>
	   		</c:forEach>
   		</div>
